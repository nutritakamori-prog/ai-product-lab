...
preconditions, steps, expected outcome, priority, category — one file per
scenario under this folder, listed in `index.ts`, read through
...
_(One scenario only today: `new-user-creates-first-project`.)_
